...
const Presentation = () => {
  const dataIcon = [
    ...
    <svg
      ...
      height="40"
      fill="#005AAD"
      className="bi bi-cart  m-auto w-10"
      viewBox="0 0 16 16"
    >
    ...
    <section className=" flex flex-wrap  justify-center text-center my-16 ">
      {services.map((service, index) => (
        <Fade
          ...
          // direction="left"
          duration={3500}
          className="border border-[#005AAD] dark:border-[#0070d8] w-full lg:w-1/4 p-8  m-4"
        >
          <article>
            <div className="self-center m-auto"> {dataIcon[index]}</div>
