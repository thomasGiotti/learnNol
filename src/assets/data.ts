export const services = [
  {
    ...
    title: "Dépannage",
    content:
      "Résolution de vos problèmes informatiques. Que ce soit des pannes matérielles, ralentissement de votre matériel ou des problèmes de connectivité ou des virus.",
  },
  {
    id: 2,
    title: "Vente et installation",
    content:
      "Fourniture et pose de postes de travail, imprimantes, écrans, clavier, souris.",
  },
  {
    id: 3,
    title: "Maintenance",
    content:
      "Contrôles réguliers, mises à jour logicielles, anticipation des pannes possibles ou de problèmes techniques de votre parc informatique.",
  },
  {
    id: 4,
    title: "Upgrade",
    content:
      "Upgrade de matériel informatique pour améliorer les performances et la capacité de votre système existant. ",
  },
  {
    id: 5,
    title: "Assemblage",
    content:
      "Choix des composants, montage précis et professionnel. Que vous souhaitiez créer un ordinateur gaming puissant, une station de travail performante ou un serveur sur mesure.",
  },
  {
    id: 6,
    title: "Gaming",
    content:
      "Création et de maintenance de serveurs Counter-Strike. Configuration initiale du serveur selon vos besoins spécifiques, en incluant les paramètres de jeu, les plugins, les modèles de carte, et plus encore.",
  },
];
